 ...
 * href="http://www.jibble.org/pircbot.php">http://www.jibble.org/pircbot.php</a>
...
public abstract class PircBot implements ReplyConstants {
    ...
    private static final Logger LOGGER = Logger.getLogger(PircBot.class.getName());
    ...
    public final synchronized void connect(String hostname, int port, String password) throws IOException,
        ...
        LOGGER.fine("*** Logged onto server.");
     ...
     *            The message to send.
     * 
     * @see org.jibble.pircbotm.Colors
     */
    public final void sendMessage(String target, String message) {
        _outQueue.add(target, "PRIVMSG " + target + " :" + message);
    }
    ...
    public final void sendNotice(String target, String notice) {
        _outQueue.add(target, "NOTICE " + target + " :" + notice);
    }
    ...
    public final void sendCTCPCommand(String target, String command) {
        _outQueue.add(target, "PRIVMSG " + target + " :\u0001" + command + "\u0001");
    }
     ...
     * 
     * @see org.jibble.pircbotm.DccChat
     */
     ...
     * 
     * @deprecated As of PircBot 1.2.0, use
     *             {@link #onIncomingChatRequest(org.jibble.pircbotm.DccChat)}
     */
     ...
     * &quot;I am King of Test&quot; then the response will be &quot;<code>PircBot #test :I Am King of Test</code>&quot;
     ...
     *         the channel.
     * 
     * @see #onUserList(String, org.jibble.pircbotm.User[]) onUserList
     */
