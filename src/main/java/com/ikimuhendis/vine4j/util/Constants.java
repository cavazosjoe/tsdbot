...
public class Constants {
    ...
    public static final String VINE_API_POST_CREATE_PATH=VINE_API_BASE_URL+"/posts";
...
//    public static final String VINE_HTTPBODY_DEVICE_TOKEN= MiscUtils.sha1("tsdbot@teamschoolyd.org");
    public static final String VINE_HTTPBODY_DEVICE_TOKEN="1111111111111111111";
